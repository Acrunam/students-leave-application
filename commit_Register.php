...
$strQuery = "INSERT INTO users (adm_no,fname,lname,email,user_category,password) VALUES ('$amdno','$fn','$ln','$email','$usercat','$entered_password')";
